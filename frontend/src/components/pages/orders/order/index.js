...
const Order = () => {
  ...
  return (
      <div className='ml-[6rem] container flex flex-col md:flex-row w-[90%]'>
                ...
                : (
                  <div>
                    <table className='w-[80%] bg-white text-black'>
                      <thead>
                        <tr>
                          <th className='p-2 border border-black text-center font-semibold'>Image</th>
                          <th className='p-2 border border-black text-center font-semibold'>Product</th>
                          <th className='p-2 border border-black text-center font-semibold'>Quantity</th>
                          <th className='p-2 border border-black text-center font-semibold'>Unit Price</th>
                          <th className='p-2 border border-black text-center font-semibold'>Total</th>
                        </tr>
                      </thead>
                      <tbody>
                        {
